...
TRAINING_EXPLORATION_SEED: int = 2027
TRAINING_LOW_BUFFER_EXPLORE_PROBABILITY: float = 0.30
...
RNN_STARTUP_SEGMENTS: int = RNN_SEQUENCE_LENGTH
RNN_FEATURE_SIZE: int = 16
RNN_TARGET_SIZE: int = 3
RNN_HIDDEN_SIZE: int = 64
RNN_SERVER_SELECTION_MARGIN_KBPS: float = 30.0
RNN_OBSERVED_PROBE_RANKING_WEIGHT: float = 0.70
ABR_HISTORY_SIZE: int = 5
SAFETY_FACTOR: float = 0.92
POLICY2_BUFFER_RESPONSE_POWER: float = 1.25
POLICY2_MAX_BOOST_FACTOR: float = 1.50
ALPHA_JITTER_EWMA: float = 0.3
ALPHA_THROUGHPUT_EWMA: float = 0.6
